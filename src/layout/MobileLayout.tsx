...
const MobileLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="w-full h-full min-h-screen bg-slate-50 flex flex-col max-w-md mx-auto shadow-2xl overflow-hidden relative">
        {/* Dynamic Header */}
        ...
        {/* Bottom Navigation */}
        <nav className="absolute bottom-0 w-full bg-white border-t border-slate-200 py-3 pb-6 safe-area-bottom z-50 px-6 flex justify-between items-center shadow-[0_-5px_10px_rgba(0,0,0,0.05)]">
            {navItems.map((item) => {

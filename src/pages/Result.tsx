import { AlertCircle, CheckCircle, AlertTriangle, TrendingDown, Info } from 'lucide-react';
...
const Result = () => {
  ...
  return (
    <div className="h-full overflow-y-auto w-full p-6 pb-6 relative scroll-smooth space-y-6 animate-in slide-in-from-bottom-4 duration-700">

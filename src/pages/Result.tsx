...
const Result = () => {
  ...
  const reportData = {
    ...
    risks: [
      { id: 1, type: "danger", title: "영업지역 보호 조항 누락", content: "가맹본부는 가맹점사업자의 영업에 지장을 주지 않도록 일정 거리 내 신규 가맹점 설립을 제한할 의무가 있습니다. (제 2조)" },
      { id: 2, type: "warning", title: "과도한 위약금 설정", content: "중도 해지 시 잔여 기간 로열티의 300%를 지급해야 한다는 조항은 통상적인 위약금 수준을 초과합니다. (제 4조)" },
      { id: 3, type: "warning", title: "불공정 물품 구매 강제", content: "모든 물품을 본사 지정처에서만 구매하도록 강제하는 것은 거래상 지위 남용에 해당할 수 있습니다. (제 5조)" }
    ],
    brandStats: {
      growth: "+15%",
      closingRate: "3.2%",
